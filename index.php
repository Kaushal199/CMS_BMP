...
<head>
    ...
    <title>Welcome | CMS DAIICT</title>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="position-relative d-flex text-center text-white promo-banner-bg py-3">
        <div class="p-lg-2 mx-auto my-5">
            <h1 class="display-5 fw-normal">Welcome to CMS@DAIICT</h1>
            <p class="lead fw-normal">Food ordering system of DAIICT Campus Canteen</p>
            <span class="xsmall-font text-muted">Image</span>
        </div>
    </div>
    ...
    <footer
        ...
        <span class="smaller-font">&copy; BMP<br /><span class="xsmall-font">Nemin S. Kaushal J.
                DA-IICT.</span></span>
        <ul class="nav justify-content-end list-unstyled d-flex">
            <li class="ms-3"><a class="text-light" target="_blank" href="https://github.com/Kaushal199/CMS_BMP/"><i
