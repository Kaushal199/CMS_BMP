...
<body class="d-flex flex-column h-100">
    ...
    <footer
        ...
        <span class="smaller-font">&copy; BMP<br /><span class="xsmall-font"><a href="admin/admin_login.php" class="text-decoration-none text-light">Nemin S.</a> Kaushal J.
                DA-IICT.</span></span>
